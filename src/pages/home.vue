<template>
  <div class="home">
    ...
    <div class="previews">
      ...
      <div class="preview">
        <router-link :to="'/resume/material-dark-projects'">
          <div class="preview-wrapper">
      ...
      <div class="preview">
        <router-link :to="'/resume/left-right'">
          <div class="preview-wrapper">
      ...
      <div class="preview">
        <router-link :to="'/resume/left-right-projects'">
          <div class="preview-wrapper">
      ...
      <div class="preview">
        <router-link :to="'/resume/left-right-rtl'">
          <div class="preview-wrapper">
      ...
      <div class="preview">
        <router-link :to="'/resume/oblique-projects'">
          <div class="preview-wrapper">
      ...
      <div class="preview">
        <router-link :to="'/resume/oblique-rtl'">
          <div class="preview-wrapper">
      ...
      <div class="preview">
        <router-link :to="'/resume/side-bar-projects'">
          <div class="preview-wrapper">
      ...
      <div class="preview">
        <router-link :to="'/resume/side-bar-rtl'">
          <div class="preview-wrapper">
      ...
      <div class="preview">
        <router-link :to="'/resume/creative'">
          <div class="preview-wrapper">
      ...
      <div class="preview">
        <router-link :to="'/resume/cool-rtl'">
          <div class="preview-wrapper">
      ...
      <div class="preview">
        <router-link :to="'/resume/cool-rtl2'">
          <div class="preview-wrapper">
