<template>
  <section class="control-container">
    ...
    <section class="item-container">
      ...
      >
        <section class="control">
          <span class="item-label"> {{ control.label }} </span>
        ...
        <section class="options-container">
          <section class="options-item">
            ...
            <span class="options-value"> {{ control.type }} </span>
          </section>

          <section class="options-item">
            <span class="options-title"> Options: </span>

            <span class="options-value"> {{ control.options }} </span>
          </section>
        </section>
        ...
        <section v-if="control.label === 'manual-pagination:'">
          ...
          <br />
          When enabling this prop, the prop
          <br />

          <b> paginate-elements-by-height </b>
          will not be used. Instead the pagination process will rely on the
          elements with a class "html2pdf__page-break" to know where to page
          break.
        </section>
      </section>
      ...
      <div>
        ...
        <b>html-to-pdf-options</b>
        , if you set a value to this prop, the props below will be overridden:
        <br />
    ...
    <section class="progress-container">
      ...
      <section v-if="progress !== 0" class="generating-label">
