      ...
      <div class="contact">
        ...
        <table>
          <tr>
            ...
            <td
              ><a :href="contactLinks.email">{{ person.contact.email }}</a></td
            >
          </tr>
          <tr>
            <td><i class="fa fa-phone" aria-hidden="true"></i></td>
            <td
              ><a :href="contactLinks.phone">{{ person.contact.phone }}</a></td
            >
          </tr>
          <tr>
          ...
          <tr v-if="person.contact.github">
            ...
            <td
              ><a :href="contactLinks.github">{{ contactLinks.github }}</a></td
            >
          </tr>
        </table>
      </div>
